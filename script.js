...
const script_najeon = [
    ...
    { speaker: "무역상", text: "나전과 어피로 만들어진 두 마리 용이 구름 속에서 여의주를 놓고 싸우고 있네요!", img: img3f_3ham, imgwidth: "80%", imgBottom: "45%" },
...
const floor5Dialogs = [
    ...
    { speaker: "타미", text: "조용히 해 해버마 담당자도 아이디어의 한계가 있는거야", img: imgTamiShh, imgWidth: "70%", imgBottom: "45%" },
    ...
    { speaker: "타미", text: "아주 날카로운 질문이야 해버마! 옛날에는 배를 만든다고 하지 않고 '모은다'고 할 정도로 정성이 많이 들어갔지.", img: imgTamiShh, imgWidth: "70%", imgBottom: "45%" },
